...
public class SubscribedHeadlineAdapter extends ArrayAdapter<Headline> {

    private Context context;
    private List<Headline> headlineList;

    public SubscribedHeadlineAdapter(Context c, int resource, ArrayList<Headline> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //view = inflater.inflate(R.layout.subscribed_headline_custom, null);
        if (view == null)
            view = inflater.inflate(R.layout.subscribed_headline_custom, parent, false);

        TextView tv_new = (TextView) view.findViewById(R.id.newArticle);
        TextView tv_title = (TextView) view.findViewById(R.id.title);
        TextView tv_sourceTitle = (TextView) view.findViewById(R.id.sourceTitle);
        ...
        ImageView tv_sourceImage = (ImageView) view.findViewById(R.id.imageSource);
